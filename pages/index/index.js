      ...
      wx.login({
          success(res) {
              if (res.code) {
                  ...
                  wx.request({
                      url: ('https://api.weixin.qq.com/sns/jscode2session?appid=wx5e3066fcc86059d3&secret=fe0b3177e4f79c2d1786d51cab2a3b8f&js_code=' + res.code + '&grant_type=authorization_code'),
